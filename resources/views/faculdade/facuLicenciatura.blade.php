        ...
        <div class="page-contents">
            <div class="content-details">
                <h1 id="product-title" class="detail-title">
                    <span>{{ $licen->titleFirst }}  </span>
                    <strong class="title-size-small"> {{ $licen->titleSecond }} <span>{{ $licen->third }}<span>{{ $licen->titlethird }}</span></strong>
                </h1>
                ...
                <div class="detail-section">
                    ...
                    <div class="video-responsive">
                        <iframe src="{{ url( $licen->video ) }}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                        </iframe>
                    </div>
                        ...
                        <div class="planos ">
                            ...
                            <div class="col-content">
                                <ul class="content-list">
                                    ...
                                    <li class="list-item">
                                        <p>{{ $licen->workloadDate }}</p>
                                    </li>
                                    <li class="list-item">
                                        <div class="price">
                                            <sub>R$</sub>
                                            <span>{{ $licen->investmentFirst }}</span>
                                            <sub>/mês</sub>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="become-teacher__form">
                                                        ...
                                                        <form action="{{ route('facuMatricula') }}" method="post" autocomplete="off" class="become-teacher__form-content">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" id="course" name="course" class="form-control {{ ($errors->has('course') ? 'is-invalid' : '') }}" value="{{ $licen->titleSecond }} em 48 meses" placeholder="Assunto" required >
                            ...
                            <div class="col-content highlight">
                                <ul class="content-list">
                                    ...
                                    <li class="list-item">
                                        <div class="price">
                                            <sub>R$</sub>
                                            <span>{{ $licen->investmentSecond }}</span>
                                            <sub>/mês</sub>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="become-teacher__form">
                                                        ...
                                                        <form action="{{ route('facuMatricula') }}" method="post" autocomplete="off" class="become-teacher__form-content">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" id="course" name="course" class="form-control {{ ($errors->has('course') ? 'is-invalid' : '') }}" value="{{ $licen->titleSecond }} em 64 meses" placeholder="Assunto" required >
                                                                @if($errors->has('course'))
                                                                    <div class="invalid-feedback">
                                                                        {{ $errors->first('course') }}
                                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="become-teacher__form">
                                                        ...
                                                        <form action="{{ route('facuMatricula') }}" method="post" autocomplete="off" class="become-teacher__form-content">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" id="course" name="course" class="form-control title_course{{ ($errors->has('course') ? 'is-invalid' : '') }}" value="{{ $licen->titleSecond }} em 64 meses" placeholder="Assunto" required >
                                                                @if($errors->has('course'))
                                                                    <div class="invalid-feedback">
                                                                        {{ $errors->first('course') }}
                                                                    </div>
                ...
                <div class="detail-section">
                    <div class="section-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <img class="section-responsive-image" src="{{ url('faculdade/assets/images/material-02.jpg') }}" alt="Material didático">
                        ...
                        <div class="item">
                            <img class="section-responsive-image" src="{{ url('faculdade/assets/images/material-03.jpg') }}" alt="Material didático">
                            <div class="text">Para cada capítulo do livro, há uma videoaula correspondente</div>
                        </div>
                        <div class="item">
                            <img class="section-responsive-image" src="{{ url('faculdade/assets/images/material-04.jpg') }}" alt="Material didático">
                        ...
                        <div class="item">
                            <img class="section-responsive-image" src="{{ url('faculdade/assets/images/material-05.jpg') }}" alt="AVA - Ambiente Virtual de Aprendizagem">
                ...
                <div class="detail-section">
                    <div class="section-thumbs">
                        <div class="thumb">
                            <figure class="thumb-figure">
                                <img class="figure-img" src="{{ url('faculdade/assets/images/ilustracao-1.png') }}" alt="Avaliação - Etapa 3">
                            </figure>
                            <div class="thumb-text">
                        ...
                        <div class="thumb">
                            <figure class="thumb-figure">
                                <img class="figure-img" src="{{ url('faculdade/assets/images/ilustracao-2.png') }}" alt="Avaliação - Etapa 4">
                            </figure>
                            <div class="thumb-text">
                    ...
                    <div class="section-thumbs">
                        <div class="thumb">
                            <figure class="thumb-figure">
                                <img class="figure-img" src="{{ url('faculdade/assets/images/ilustracao-3.png') }}" alt="Avaliação - Etapa 3">
                            </figure>
                            <div class="thumb-text">
                        ...
                        <div class="thumb">
                            <figure class="thumb-figure">
                                <img class="figure-img" src="{{ url('faculdade/assets/images/ilustracao-4.png') }}" alt="Avaliação - Etapa 4">
                            </figure>
                            <div class="thumb-text">
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->a1First }} </td>
                                        <td class="center">{{ $licen->a1FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a1Second }} </td>
                                        <td class="center">{{ $licen->a1SecondHours }} </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a1Third }} </td>
                                        <td class="center">{{ $licen->a1ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a1Four }} </td>
                                        <td class="center">{{ $licen->a1FourHours }}</td>
                                    </tr>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->b1First }} </td>
                                        <td class="center">{{ $licen->b1FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b1Second }} </td>
                                        <td class="center">{{ $licen->b1SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b1Third }} </td>
                                        <td class="center">{{ $licen->b1ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b1Four }} </td>
                                        <td class="center">{{ $licen->b1FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->a2First }} </td>
                                        <td class="center">{{ $licen->a2FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a2Second }} </td>
                                        <td class="center">{{ $licen->a2SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a2Third }} </td>
                                        <td class="center">{{ $licen->a2ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a2Four }} </td>
                                        <td class="center">{{ $licen->a2FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->b2First }} </td>
                                        <td class="center">{{ $licen->b2FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b2Second }} </td>
                                        <td class="center">{{ $licen->b2SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b2Third }} </td>
                                        <td class="center">{{ $licen->b2ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b2Four }} </td>
                                        <td class="center">{{ $licen->b2FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->a3First }} </td>
                                        <td class="center">{{ $licen->a3FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a3Second }} </td>
                                        <td class="center">{{ $licen->a3SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a3Third }} </td>
                                        <td class="center">{{ $licen->a3ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a3Four }} </td>
                                        <td class="center">{{ $licen->a3FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->b3First }} </td>
                                        <td class="center">{{ $licen->b3FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b3Second }} </td>
                                        <td class="center">{{ $licen->b3SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b3Third }} </td>
                                        <td class="center">{{ $licen->b3ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b3Four }} </td>
                                        <td class="center">{{ $licen->b3FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->a4First }} </td>
                                        <td class="center">{{ $licen->a4FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a4Second }} </td>
                                        <td class="center">{{ $licen->a4SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a4Third }} </td>
                                        <td class="center">{{ $licen->a4ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a4Four }} </td>
                                        <td class="center">{{ $licen->a4FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->b4First }} </td>
                                        <td class="center">{{ $licen->b4FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b4Second }} </td>
                                        <td class="center">{{ $licen->b4SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b4Third }} </td>
                                        <td class="center">{{ $licen->b4ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b4Four }} </td>
                                        <td class="center">{{ $licen->b4FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->a5First }} </td>
                                        <td class="center">{{ $licen->a5FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a5Second }} </td>
                                        <td class="center">{{ $licen->a5SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a5Third }} </td>
                                        <td class="center">{{ $licen->a5ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a5Four }} </td>
                                        <td class="center">{{ $licen->a5FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->b5First }} </td>
                                        <td class="center">{{ $licen->b5FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b5Second }} </td>
                                        <td class="center">{{ $licen->b5SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b5Third }} </td>
                                        <td class="center">{{ $licen->b5ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b5Four }} </td>
                                        <td class="center">{{ $licen->b5FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->a6First }} </td>
                                        <td class="center">{{ $licen->a6FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a6Second }} </td>
                                        <td class="center">{{ $licen->a6SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a6Third }} </td>
                                        <td class="center">{{ $licen->a6ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a6Four }} </td>
                                        <td class="center">{{ $licen->a6FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->b6First }} </td>
                                        <td class="center">{{ $licen->b6FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b6Second }} </td>
                                        <td class="center">{{ $licen->b6SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b6Third }} </td>
                                        <td class="center">{{ $licen->b6ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b6Four }} </td>
                                        <td class="center">{{ $licen->b6FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->a7First }} </td>
                                        <td class="center">{{ $licen->a7FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a7Second }} </td>
                                        <td class="center">{{ $licen->a7SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a7Third }} </td>
                                        <td class="center">{{ $licen->a7ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a7Four }} </td>
                                        <td class="center">{{ $licen->a7FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->b7First }} </td>
                                        <td class="center">{{ $licen->b7FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b7Second }} </td>
                                        <td class="center">{{ $licen->b7SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b7Third }} </td>
                                        <td class="center">{{ $licen->b7ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b7Four }} </td>
                                        <td class="center">{{ $licen->b7FourHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->a8First }} </td>
                                        <td class="center">{{ $licen->a8FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a8Second }} </td>
                                        <td class="center">{{ $licen->a8SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a8Third }} </td>
                                        <td class="center">{{ $licen->a8ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->a8Four }} </td>
                                        <td class="center">{{ $licen->a8FourHours }}</td>
                                    </tr>
                            ...
                            <div class="container-disciplina">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            {{ $licen->b8First }} </td>
                                        <td class="center">{{ $licen->b8FirstHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b8Second }} </td>
                                        <td class="center">{{ $licen->b8SecondHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b8Third }} </td>
                                        <td class="center">{{ $licen->b8ThirdHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b8Four }} </td>
                                        <td class="center">{{ $licen->b8FourHours }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            {{ $licen->b8Fifth }} </td>
                                        <td class="center">{{ $licen->b8FifthHours }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <h2 class="detail-title" id="objetivo"><strong class="title-size-big">OBJETIVO DO CURSO</strong></h2>
                 <div class="detail-section objetivo">
                    <p>{{ $licen->courseDescription }}</p>
                    <p>{{ $licen->courseSubDescription }}</p>
                    <ul class="section-topics">
                        <li class="topic">{{ $licen->courseFirst }}</li>
                        <li class="topic">{{ $licen->courseSecond }}</li>
                        <li class="topic">{{ $licen->courseThird }}</li>
                        <li class="topic">{{ $licen->courseBedroom }}</li>
                        <li class="topic">{{ $licen->courseFifth }}</li>
                        <li class="topic">{{ $licen->courseSixth }}</li>
                        <li class="topic">{{ $licen->courseSeventh }}</li>
                        <li class="topic">{{ $licen->courseEighth }}</li>
                        <li class="topic">{{ $licen->courseNinth }}</li>
                    </ul>
                </div>
